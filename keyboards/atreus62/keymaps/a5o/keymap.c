...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
	...
	MO(_MACRO), MO(_FUN), KC_LGUI, KC_LALT, RAISE, KC_SPC, KC_BSPC, RCTL_T(KC_ENT), KC_SPC, LOWER, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
  ),

	[_LOWER] = LAYOUT(
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, UC(EUR), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, UC(NOTEQ),
	KC_TRNS, KC_TRNS, KC_TRNS, UP(1,7), UC(REG), UC(TM), KC_TRNS, UP(3,9), UP(4,10), UP(5,11), KC_TRNS, UC(PLMIN),
	KC_TRNS, UP(2,8), KC_TRNS, UC(DEGREE), KC_TRNS, KC_TRNS, TMUXH, TMUXJ, TMUXK, TMUXL, KC_TRNS, UC(ALM),
	KC_TRNS, TMUXZ, KC_TRNS, UC(COPY), KC_TRNS, KC_TRNS, KC_TRNS, UC(MICRO), UC(LTEQ), UC(GTEQ), KC_TRNS, KC_BSLS,
	...
	KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_INS, KC_END, KC_PGUP, KC_F12, 
	KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_PGDN, KC_NO, 
  ...
  [_MACRO] = LAYOUT(
    ...
    KC_NO  ,       KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,                     KC_NO  , DM_REC1  , DM_REC2  , DM_RSTP  , KC_NO  , KC_NO   ,
    KC_NO  ,       KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,                     KC_NO  , DM_PLY1  , DM_PLY2  , KC_NO  , KC_NO  , KC_NO   ,
    KC_NO  ,       KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,                     KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO   ,
