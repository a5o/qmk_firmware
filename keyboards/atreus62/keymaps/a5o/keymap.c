...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_MEH, MO(_FUN), KC_LGUI, KC_LALT, RAISE, LT(_DIR,KC_SPC), KC_BSPC, RCTL_T(KC_ENT), LT(_MOUSE,KC_SPC), LOWER, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
	),
...
//	),
	...
	KC_TRNS, KC_NO, KC_NO, KC_WH_U, KC_WH_D, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
	KC_TRNS, KC_NO, KC_BTN3, KC_BTN2, KC_BTN1, KC_NO, KC_MS_L,KC_MS_D, KC_MS_U, KC_MS_R, KC_NO, KC_NO,
