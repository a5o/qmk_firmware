...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, UC(EGRV),   UC(REG),  UC(TM),  _______, UC(UGRV), UC(IGRV), UC(OGRV), _______, _______, _______, _______, KC_HOME,
        _______, UC(AGRV), _______, UC(DEGREE), _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_END,
    ...
    [_FN2] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, UC(EACU), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_ADJUST] = LAYOUT_65_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, QK_BOOT, _______, _______,   _______,  _______,  AG_SWAP, AG_NORM, _______, _______, _______, _______, _______, _______, _______,
